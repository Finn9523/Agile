...
public partial class AgileStoreContext : DbContext
{
    public AgileStoreContext()
    {
    }

    public AgileStoreContext(DbContextOptions<AgileStoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-FSPM5U29\\SQLEXPRESS; Database = AgileStore; Integrated Security = True; Trust Server Certificate = True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BanBe>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNavigation).WithMany(p => p.BanBes)
                .HasForeignKey(d => d.Id)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BanBe_Users");
        ...
        {
            entity.HasKey(e => e.MaGh).HasName("PK_CART");
            ...
            entity.HasOne(d => d.IdNavigation).WithMany(p => p.GioHangs)
                .HasForeignKey(d => d.Id)
        ...
        modelBuilder.Entity<HoaDon>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNavigation).WithMany(p => p.HoaDons)
                .HasForeignKey(d => d.Id)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<YeuThich>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNavigation).WithMany(p => p.YeuThiches)
                .HasForeignKey(d => d.Id)
...
public DbSet<AgileCommercee.Data.Users> Users_1 { get; set; } = default!;
}
